  ...
  return (
    <div className="hud">
      ...
      <div className="hud-top-right">
        ...
        <button className="hud-icon-btn" onClick={onOpenEmotes} title="Emotes (R)"><IconSparkle /></button>
        <button className="hud-icon-btn" onClick={onOpenPause} title="Meny (Esc)"><IconMenu /></button>
      </div>

      {!isMobile && (
        <div className="hud-controls-hint">WASD/piltaster: Bevege deg · Shift: Løpe · E: Samhandle · I: Ryggsekk · J: Dagbok · R: Emotes · Esc: Meny</div>
      )}
    </div>
  );
}
